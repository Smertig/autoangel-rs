use crate::elements::game::GameDialect;
use crate::elements::util::DataType;
use once_cell::sync::Lazy;
use std::collections::HashMap;

pub struct PWGameDialect;

impl GameDialect for PWGameDialect {
    ...
    fn dt_to_space(&self, dt: DataType) -> Option<&'static str> {
        return DT_TO_SPACE
            .get(&dt.0)
            .copied()
            .map(|space_id| match space_id {
                ID_SPACE_ESSENCE => "essence",
                ID_SPACE_ADDON => "addon",
                ID_SPACE_TALK => "talk",
                ID_SPACE_FACE => "face",
                ID_SPACE_RECIPE => "recipe",
                ID_SPACE_CONFIG => "config",
                ID_SPACE_HOME => "home",
                _ => unreachable!(),
            });

        pub static DT_TO_SPACE: Lazy<HashMap<i32, i32>> = Lazy::new(|| {
            use RawDataType::*;
            ...
            vec![
                ...
                (DT_HOME_CONFIG, ID_SPACE_CONFIG),
                (DT_HOME_PRODUCTS_CONFIG, ID_SPACE_CONFIG),
                (DT_HOME_RESOURCE_PRODUCE_CONFIG, ID_SPACE_CONFIG),
                (DT_HOME_FORMULAS_PRODUCE_RECIPE, ID_SPACE_RECIPE),
                (DT_HOME_FORMULAS_ITEM_ESSENCE, ID_SPACE_ESSENCE),
                (DT_HOME_PRODUCE_SERVICE_CONFIG, ID_SPACE_CONFIG),
                (DT_HOME_FACTORY_CONFIG, ID_SPACE_CONFIG),
                (DT_HOME_ITEM_MAJOR_TYPE, ID_SPACE_HOME),
                (DT_HOME_ITEM_SUB_TYPE, ID_SPACE_HOME),
                (DT_HOME_ITEM_ENTITY, ID_SPACE_HOME),
                (DT_HOME_FORMULAS_PRODUCE_MAJOR_TYPE, ID_SPACE_RECIPE),
                (DT_HOME_FORMULAS_PRODUCE_SUB_TYPE, ID_SPACE_RECIPE),
                (DT_HOME_FORMULAS_ITEM_MAJOR_TYPE, ID_SPACE_ESSENCE),
                (DT_HOME_FORMULAS_ITEM_SUB_TYPE, ID_SPACE_ESSENCE),
                (DT_HOME_STORAGE_TASK_CONFIG, ID_SPACE_CONFIG),
                (DT_WISH_TRIBUTE_ESSENCE, ID_SPACE_ESSENCE),
                (DT_RED_PACKET_PAPER_ESSENCE, ID_SPACE_ESSENCE),
            ]
            .into_iter()
            .map(|(dt, space)| (dt as i32, space))
            .collect()
        });
    }
}

const ID_SPACE_ESSENCE: i32 = 0;
const ID_SPACE_ADDON: i32 = 1;
const ID_SPACE_TALK: i32 = 2;
const ID_SPACE_FACE: i32 = 3;
const ID_SPACE_RECIPE: i32 = 4;
const ID_SPACE_CONFIG: i32 = 5;
const ID_SPACE_HOME: i32 = 6;

#[allow(non_camel_case_types)]
enum RawDataType {
    //DT_INVALID = 0,
    DT_EQUIPMENT_ADDON = 1,
    ...
    DT_ASTROLABE_APPEARANCE_CONFIG = 205,
    ...
    DT_SOLO_TOWER_CHALLENGE_SCORE_COST_CONFIG = 210,
    ...
    DT_HOME_PRODUCE_SERVICE_CONFIG = 220,
    DT_HOME_FACTORY_CONFIG,
    DT_HOME_ITEM_MAJOR_TYPE,
    DT_HOME_ITEM_SUB_TYPE,
    DT_HOME_ITEM_ENTITY,

    DT_HOME_FORMULAS_PRODUCE_MAJOR_TYPE = 225,
